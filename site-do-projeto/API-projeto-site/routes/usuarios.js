...
router.post('/autenticar', function(req, res, next) {
	...
	var login_backend = req.body.email; // depois de .body, use o nome (name) do campo em seu formulário de login
	var senha = req.body.senha; // depois de .body, use o nome (name) do campo em seu formulário de login	
	
	let instrucaoSql = `select * from usuario where email ='${login_backend}' and senha='${senha}'`;
...
router.get('/sessao/:login_bd', function(req, res, next) {
	let login_backend = req.params.email;
...
/* Logoff de usuário */
router.get('/sair/:login_bd', function(req, res, next) {
	let login_backend = req.params.email;
